    ...
    <Sheet open={isSoundscapesVisible} onOpenChange={setSoundscapesVisible}>
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1569935801172-5b458e214ee8?q=80&w=720&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
