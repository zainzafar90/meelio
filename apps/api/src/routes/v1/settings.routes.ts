...
router
  ...
  .patch(
    auth(),
    validate(settingsValidation.updateTaskSettingsSchema),
    settingsController.updateTaskSettings
  );
router
  .route("/calendar")
  .patch(
    auth(),
    validate(settingsValidation.updateCalendarSettingsSchema),
    settingsController.updateCalendarSettings
  );
