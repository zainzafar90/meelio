...
If you did not request any password resets, then ignore this email.`;
  ...
  <p>Thanks,</p>
  <p><strong>Meelio Team</strong></p></div>`;
...
If you did not create an account, then ignore this email.`;
  ...
  sendSuccessfulRegistration: async (
    to: string,
    token: string,
    name: string
  ): Promise<void> => {
    const subject = "Welcome to Meelio";
  ...
  sendMagicLinkEmail: async (token: string, email: string): Promise<void> => {
    const subject = "Login to Meelio";
    const clientUrl =
  ...
  sendAccountCreated: async (to: string, name: string): Promise<void> => {
    const subject = "Welcome to Meelio";
